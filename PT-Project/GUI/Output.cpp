...
Output::Output(){
	...
	pWind->DrawImage(dir+"images\\bg1.jpg", 0, UI.TlBrWdth);
	//Change the title
...
{
	pWind->DrawLine(0, UI.height - UI.StBrWdth, UI.width, UI.height - UI.StBrWdth);
	pWind->DrawImage(dir + "images\\statusbar.jpg", 0, UI.height - 47);
}
//////////////////////////////////////////////////////////////////////////////////////////
void Output::ClearDrawArea()
{
	if (UI.AppMode == DESIGN)
	{
		...
		pWind->DrawImage(dir + "images\\bg.jpg", 0, UI.TlBrWdth,UI.width,UI.height-UI.StBrWdth-UI.TlBrWdth);
	}
	else
	{
		pWind->SetPen(BLACK, 1);
		pWind->DrawImage(dir + "images\\bg.jpg", 0, UI.TlBrWdth, UI.width, UI.height - UI.StBrWdth - UI.TlBrWdth); //New !
	}
	CreateStatusBar();
